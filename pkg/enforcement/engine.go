...
// request, or nil if none match. Exported so callers that need the matched constraint
// (e.g. the validate endpoint) can reuse the engine's selection logic. Tie-breaking is
// stable: at equal specificity, the first in the list wins.
