...
// TestExpandHome_BareTilde regression: a path of exactly "~" (no trailing slash) must
// expand to the home directory, not be returned unchanged — otherwise openAuditSink
// would MkdirAll a directory literally named "~" under the CWD and silently misdirect
// the tamper-evident audit log there.
