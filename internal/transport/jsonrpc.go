...
// this through BuildInitializeRequestWithID (the whole message), not through the params alone,
// so the handshake stays identical to the running proxy's without a second exported
// spelling of it.
