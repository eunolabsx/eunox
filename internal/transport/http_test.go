...
func (r recordingDecisionPoint) CommitDeclassified(ctx context.Context, sessionID string, labels []string) ([]string, error) {
	return r.inner.CommitDeclassified(ctx, sessionID, labels)
}
