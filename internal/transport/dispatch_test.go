...
func (orderTrackingRecorder) RecordDeclassifiedAllow(context.Context, string, string, string, map[string]interface{}, []string, bool, []string, []string, []string, string) {
}
...
func TestDispatchList_NoPolicyUsesDenyAll(t *testing.T) {
	...
	d := dispatchParams{
		...
		pdp: pdp.DenyAllPDP{}, // the "no policy" default the constructors substitute
	}
