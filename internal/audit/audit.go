...
// from the closed native vocabulary and are counted for completeness, not bounds; so is
// the enforcement-point stamp, which this process chooses once and repeats on every record.
//
