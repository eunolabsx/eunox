...
// TestInterpretAuditTail_WhitespaceOnlyFinalLine is the finding-1 unit regression:
...
// TestOpenResumesPastWhitespaceTail is the finding-1 end-to-end regression: a whitespace
...
// TestHighestSeqAcrossChain is the finding-2 mechanism: the cross-chain seed must fold in
...
// TestOpenFailsClosedOnOversizedOrphanTail is the finding-5 regression: a trailing partial
...
// TestRotatedPath_OrdinalUncertainUnreadableDir_Defers is the finding-7 regression: when
...
// TestOpenGuardedAppend_RefusesSymlink is the finding-10 regression: the post-rotation
...
// TestNewestRotatedSiblingWithTail_SkipsEmptyReturnsNewest confirms finding-3's fix
